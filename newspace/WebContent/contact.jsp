...
<!--[if gt IE 8]><!--> <html class="no-js" lang="ko"> <!--<![endif]-->
    <head>
		...
		<style>
    		...
    		.clickBtn {
	            border: 1px solid #0891f9 !important;
	        }
 ...
 -->
        ...
        <div class="culmn">
            ...
            <section class="contact p-top-50">
                <form id="contact-form" action="ContactService.do" method="post">
                	<input type="hidden" name = "sex" value = ""/>
                	<input type="hidden" name = "age" value = "" />
                    <div class="container">
                        <h2 class="m-bottom-10 m-top-100 text-center"><span class="separator2"></span><span class="text text-black">회원가입</span><span class="separator1"></span> </h2>
                        <p class="text-center">회원 정보를 입력하세요.</p>
                        <div class="row contact-form">
                            ...
                            <div class="col-sm-12 col-md-8 col-md-offset-2 m-top-30">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="이름을 입력하세요." name = "name" required="required">
                                </div>
                            </div>                               
                            <div class="col-sm-12 col-md-8 col-md-offset-2 m-top-30">
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="이메일을 입력하세요." name = "email" required="required">
                                </div>
                            </div>                         
							<div class="col-sm-6 col-md-2 col-md-offset-2 m-top-30">
								<div class="form-group">
                                	<input type="button" readonly class="form-control button info" value="성별">
                                </div>
							</div>							                            
							<div class="col-sm-6 col-md-3 m-top-30">
								<div class="form-group">
                                    <input type="button" class="form-control button" id = "sex" name = "sex" value="여성" onclick="hidden_sex(this);">
                                </div>
							</div>
							<div class="col-sm-6 col-md-3 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" id = "sex" name = "sex" value="남성" onclick="hidden_sex(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 col-md-offset-2 m-top-30">
								<div class="form-group">
                                	<input type="button" readonly class="form-control button info" value="연령대">
                                </div>
							</div>                            
							<div class="col-sm-6 col-md-1 m-top-30">
								<div class="form-group">
                                    <input type="button" class="form-control button" id="age" value="10대" onclick="hidden_age(this);">
                                </div>
							</div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" id="age" value="20대" onclick="hidden_age(this);">                                
 								</div>
                            </div>     
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" id="age" value="30대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" id="age" value="40대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" id="age" value="50대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" id="age" value="60대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" id="age" value="70대" onclick="hidden_age(this);">                                
 								</div>
                            </div>                                                                                                                                                                                                                                                                                                                                           
                            <div class="col-sm-12 col-md-12 <col-md-of></col-md-of>fset-2 m-top-25 text-center">
                                <button type="submit" class="btn btn-default btn-round">회원가입</button>
                            </div>
                        </div>
