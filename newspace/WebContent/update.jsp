 ...
 -->
        ...
        <div class="culmn">
            ...
            <section class="contact p-top-50">
                <form id="contact-form" action="UpdateService.do" method="post">
                	<input type="hidden" name = "age" value = "" />
                    <div class="container">
                        <h2 class="m-bottom-10 m-top-100 text-center"><span class="separator2"></span><span class="text text-black">회원정보수정</span><span class="separator1"></span> </h2>
                        <div class="row contact-form">
                             <div class="col-sm-12 col-md-8 col-md-offset-2 m-top-30">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="${sessionScope.id }" name = "id" readonly="readonly">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-8 col-md-offset-2 m-top-30">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="${sessionScope.member.member_name}" name = "name">
                                </div>
                            </div>    
                             <div class="col-sm-12 col-md-8 col-md-offset-2 m-top-30">
                                <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-8 col-md-offset-2 m-top-30">
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="비밀번호를 다시 입력하세요." name = "pw2">
                                </div>
                            </div>                           
                            <div class="col-sm-12 col-md-8 col-md-offset-2 m-top-30">
                                <div class="form-group">
							...
							<div class="col-sm-6 col-md-1 m-top-30">
								<div class="form-group">
                                    <input type="button" class="form-control button" value="10대" onclick="hidden_age(this);">
                                </div>
							</div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" value="20대" onclick="hidden_age(this);">                                
 								</div>
                            </div>     
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" value="30대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" value="40대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" value="50대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" value="60대" onclick="hidden_age(this);">                                
 								</div>
                            </div>
							<div class="col-sm-6 col-md-1 m-top-30">
                                <div class="form-group">
 									<input type="button" class="form-control button" value="70대" onclick="hidden_age(this);">                                
 								</div>
                            </div>                                                                                                                                                                                                                                                                                                                                           
                            <div class="col-sm-12 col-md-12 <col-md-of></col-md-of>fset-2 m-top-25 text-center">
                            	<input type="submit" class="btn btn-default btn-round btn-submit" value="수정">             
                                <button class="btn btn-default btn-round btn-submit btn-drop" onclick="secession();">회원탈퇴</button>
                                <!--  -->
                            </div>
                        </div>
                    </div>
        ...
        <script charset="UTF-8">
        	function hidden_age(e){
         	...
         	function secession(){
        		var pw = prompt('회원탈퇴를 하시려면 현재 계정의 비밀번호를 입력하세요.');
	
        		var id = $("#id").val();
        		$.post('SecessionService.do',
        				{"id":id, "pw":pw},
        				function(data) {
        				});
        	}
